        ...
        <div className="form-container">
          <div className="flex items-center justify-center">
            ...
            <div className="flex p-2 text-gray-100 bg-gray-600 bg-opacity-30 rounded-lg">
              <i clas fa fa-map my-auto aria--hidden="true"></i>
        ...
        <div className="w-2/4 p-5">
          ...
          <div className="flex flex-col my-10">
            {weatherData.length === 0 ? (
              <div className="container p-4 flex items-center justify-centent h-1/3 mb-auto">
                <h1 className="text-gray-300 text-4xl font-bild uppercase">
                  {noData}
                </h1>
              </div>
            ) : (
